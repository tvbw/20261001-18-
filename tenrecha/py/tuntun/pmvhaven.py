# -*- coding: utf-8 -*-
"""
PMVHaven 爬虫源 (T4 / CatVod 风格)
站点导航与接口对应：
  /          最新   -> GET /api/videos?sort=-releaseDate        (首页落地列表)
  /popular   最热   -> GET /api/videos?sort=-views
  /trending  热门   -> GET /api/videos/trending?period=
  /browse    标签   -> GET /api/tags/popular  (点标签展开视频)
  /playlists 合集   -> GET /api/playlists + /api/playlists/{id}
  /random    随机   -> GET /api/videos?sort=random
"""
