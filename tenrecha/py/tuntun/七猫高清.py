...
xurl = "https://www.4477aa.com"  # https://www.5544ww.com/
...
class Spider(Spider):
    ...
    def build_category_params(self, cid, page):
        fenge = cid.split("@")
        return {'cid': fenge[0],'fcid': fenge[1],'page_no': page,'page_size': 42,'tag': 'video','sort': 'new','_v': ''}
    ...
    def extract_video_content(self, data_bb):
        ...
        return '😸丢丢为您介绍剧情📢上架时间' + update_time
